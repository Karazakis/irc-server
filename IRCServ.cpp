...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/20 17:27:04 by akoutsou          #+#    #+#             */
/*   Updated: 2024/03/28 16:56:28 by akoutsou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void IRCServ::run() {
    ...
    while (keepRunning) 
    {
        ...
        if (select(max_fd + 1, &read_fds, NULL, NULL, NULL) == -1) {
            if(keepRunning) // cerca nel read se ci sono fd pronti da leggere
                ...
                else // significa che abbiamo dati da un client esistente
                {
                    ...
                    else
                    {
                        ...
                        if(isCompleteMessage(client_buff))
                        {
                            ...
                            std::cout << "comando ricevuto contiene: ";
                            if(cmdParams.empty())
                                continue;
                            ...
                            {
                                std::string errorMessage = "Invalid password, you have been mandated a fangul, reconnect\r\n";
                            ...
                            {   
                                ...
                                else
                                {
                                    ...
                                    {
                                        std::string errorMessage = "Password required, you have been mandated a fangul, reconnect\r\n";
                                        send(i, errorMessage.c_str(), errorMessage.size(), 0);
